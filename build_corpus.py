...
def main():
    ...
    parser.add_argument('--in_path', '-i', type=str, default='data_drug/chembl_30.csv', help='input file')
    parser.add_argument('--out_path', '-o', type=str, default='data_drug/chembl_30_corpus.txt', help='output file')
